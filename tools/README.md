...
| `icon_gen.py` | Composes the executable's icon, `src/snap64.ico`, from the logo, `docs/logo.png`, on a rounded tile of the logo's own outline blue: the whole logo at 32 px and above, its film canister at 24 and 16. |
