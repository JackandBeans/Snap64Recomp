...
| `src/snap64.ico` | this project's (GPLv3) | drawn for the port by `tools/icon_gen.py` | the executable's icon, compiled in through `src/snap64.rc.in` |
| `docs/screenshots/*.png` | **not this project's**: nineteen frames of Pokémon Snap as the port renders it (Nintendo, Creatures, GAME FREAK, HAL Laboratory, The Pokémon Company) | captured from the 1.0.0 build by the port's author | the README and the release page only; not in the archive and not used by the program |
