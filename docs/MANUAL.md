...
so do [Linux and the Steam Deck](STEAM-DECK.md) and [the headset](VR.md).
...
| `vr` | `false` | draw for a VR headset through OpenXR ([VR.md](VR.md)); `SNAP_VR=1` or `0` in the environment overrides it |
