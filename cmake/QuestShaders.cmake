...
foreach(_shader props presentation copy fxaa)
    foreach(_stage vs ps)
        ...
        add_custom_command(OUTPUT "${_out}"
            ...
            DEPENDS "${CMAKE_CURRENT_SOURCE_DIR}/shaders/quest/${_shader}.hlsl"
                "${CMAKE_CURRENT_SOURCE_DIR}/shaders/quest/third_party/Fxaa3_11.h" VERBATIM)
