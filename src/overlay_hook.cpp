...
// tools/hook_funcs.py replaces both of auThreadMain's inlined AI_LEN reads.
// Read on the audio thread at consumption time, without a graphics-thread
// mailbox or any storage in guest-owned Expansion Pak memory.
extern "C" uint32_t snap_audio_remaining_bytes() {
