...
// The body characters no menu sprite contains, drawn in the sprite font's
// own style (2px stems, one antialiased fringe, caps on rows 1..9). J is
// the port's, for the Jynx Recolor row: T's bar, a stem on the right, O's
// bottom curve opening to the left. The capitals I K Q U X Y, the q and the
// punctuation are for the BUTTONS page, which names any key on the keyboard
// in this face (src/menu_assets.cpp, the row values it composes live):
// without them a key called "Q" or "Keypad /" had nothing to show.
constexpr SynthGlyph kBodySynth[] = {
    ...
    { 'z', { ".....", ".....", ".....", ".....", "####+", "++##+", ".+#+.", ".##..", "#####", "+###+" } },
    { '-', { ".....", ".....", ".....", ".....", ".....", "####+", "+++#.", ".....", ".....", "....." } },
    /* T's stem between two of its bars. */
    { 'I', { "......", "######", "+.##.+", "..#+..", "..#+..", "..#+..", "..#+..", "..#+..", "+.##.+", "######" } },
    /* The k's arms at cap height on L's stem. */
    { 'K', { ".......", ".##..##", ".#+.+#+", ".#+.#+.", ".#+#+..", ".###...", ".##+#..", ".#+.#+.", ".#+..#+", ".##..##" } },
    /* O with a tail through its lower right. */
    { 'Q', { ".......", ".......", ".+###+.", ".##+##.", "+#%.##.", "+#..+#.", "+#..+#.", ".#+#+#.", ".##+##%", ".+###+#" } },
    /* The u's shape at cap height. */
    { 'U', { ".......", ".##..##", ".#+..#+", ".#+..#+", ".#+..#+", ".#+..#+", ".#+..#+", ".#+.+#+", ".##+##+", ".+###+." } },
    { 'X', { ".......", ".##..##", ".#+..#+", ".+#.#+.", "..#+#..", "..+#+..", "..#+#..", ".+#.#+.", ".#+..#+", ".##..##" } },
    { 'Y', { ".......", ".##..##", ".#+..#+", ".+#.+#.", "..#+#+.", "..+#+..", "...#+..", "...#+..", "...#+..", "...##.." } },
    /* The p mirrored: a bowl on the x-height rows and a stem descending
     * on the right. */
    { 'q', { "......", "......", "......", "......", ".+###.", "+#+.#+", "+#..#+", ".#+%#+", ".+###+", "....#+" } },
    { '[', { "....", ".###", ".#+.", ".#+.", ".#+.", ".#+.", ".#+.", ".#+.", ".#+.", ".###" } },
    { ']', { "....", "###.", ".+#.", ".+#.", ".+#.", ".+#.", ".+#.", ".+#.", ".+#.", "###." } },
...
constexpr SynthGlyph kCreditsSynth[] = {
    ...
    { 'B', { "...", "##.", "#.#", "#.#", "##.", "#.#", "#.#", "##.", "...", "..." } },
    { 'S', { "...", "###", "#..", "#..", ".#.", "..#", "..#", "###", "...", "..." } },
    // The VR product name needs V; a missing credit glyph blocks all menu strings.
    { 'V', { "...", "#.#", "#.#", "#.#", "#.#", "#.#", "#.#", ".#.", "...", "..." } },
    { 'k', { "...", "#..", "#..", "#.#", "##.", "#.#", "#.#", "#.#", "...", "..." } },
    { 'm', { ".....", ".....", ".....", "####.", "#.#.#", "#.#.#", "#.#.#", "#.#.#", ".....", "....." } },
    { 'p', { "...", "...", "...", "##.", "#.#", "#.#", "##.", "#..", "#..", "#.." } },
